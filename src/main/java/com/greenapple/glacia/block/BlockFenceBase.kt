 ...
 */
class BlockFenceBase(registryName: String, override val unlocalizedName: String, override val itemGroup: ItemGroup?, block: Block) : FenceBlock(Properties.from(block)), IBlockBase {
