...
@OnlyIn(Dist.CLIENT)
open class ModelBipedBase<T : MobEntity> : BipedModel<T> {

    protected constructor(p_i48914_1_: Float, p_i48914_2_: Float, p_i48914_3_: Int, p_i48914_4_: Int) : super(p_i48914_1_, p_i48914_2_, p_i48914_3_, p_i48914_4_)

    @JvmOverloads
    constructor(modelSize: Float = 0.0f, p_i1168_2_: Boolean = false) : super(modelSize, 0.0f, 64, if (p_i1168_2_) 32 else 64)
