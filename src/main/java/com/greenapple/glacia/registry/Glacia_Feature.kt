...
import com.greenapple.glacia.world.feature.FeatureGlaciaIceTower
...
object Glacia_Feature : IForgeRegistryCollection<Feature<*>> {
    ...
    val ICE_TOWER = FeatureGlaciaIceTower("ice_tower", java.util.function.Function<Dynamic<*>, NoFeatureConfig> {NoFeatureConfig.deserialize(it)}, false)
}