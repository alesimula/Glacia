...
object Glacia_WorldCarver : IForgeRegistryCollection<WorldCarver<*>> {
    class WorldCarverCaveBase(registryName: String, height: Int) : CaveWorldCarver(java.util.function.Function {ProbabilityConfig.deserialize(it)}, height) {
        init {
        ...
        //carveBlock
        override fun func_225556_a_(chunkIn: IChunk, biomeProvider: java.util.function.Function<BlockPos, Biome>, carvingMask: BitSet, rand: Random, mutablePos1: BlockPos.Mutable, mutablePos2: BlockPos.Mutable, mutablePos3: BlockPos.Mutable, p_222703_7_: Int, p_222703_8_: Int, p_222703_9_: Int, p_222703_10_: Int, p_222703_11_: Int, p_222703_12_: Int, p_222703_13_: Int, p_222703_14_: Int, atomicBool: AtomicBoolean): Boolean {
                    ...
                    if (p_222703_13_ < 11) {
                        ...
                        if (atomicBool.get()) {
                            ...
                            if (chunkIn.getBlockState(mutablePos3) === Glacia.Blocks.GLACIAL_DIRT.defaultState) {
                                chunkIn.setBlockState(mutablePos3, biomeProvider.apply(mutablePos1).surfaceBuilderConfig.top, false)
                            }
                        }
                    }
